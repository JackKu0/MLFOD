        ...
        with slim.arg_scope(self.vgg_arg_scope(
            ...
            with tf.variable_scope(scope, 'img_vgg_pyr', [inputs]) as sc:
                ...
                with slim.arg_scope([slim.conv2d,
                    ...
                    # Encoder
                    conv1 = slim.repeat(inputs,    #[1,360,1200,3]
                    ...
                    upconv3 = slim.conv2d_transpose(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='upconv3')                   #[1,90,300,128]

                    concat3 = tf.concat(
                        (conv3, upconv3), axis=3, name='concat3')   #[1,90,300,256]
                    pyramid_fusion3 = slim.conv2d(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='pyramid_fusion3')            #[1,90,300,64]
                    ...
                    upconv2 = slim.conv2d_transpose(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='upconv2')                     #[1,180,600,64]

                    concat2 = tf.concat(
                        (conv2, upconv2), axis=3, name='concat2')    #[1,180,600,128]
                    pyramid_fusion_2 = slim.conv2d(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='pyramid_fusion2')              #[1,180,600,32]
                    ...
                    upconv1 = slim.conv2d_transpose(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='upconv1')                      #[1,360,1200,32]

                    concat1 = tf.concat(
                        (conv1, upconv1), axis=3, name='concat1')     #[1,360,1200,64]
                    pyramid_fusion1 = slim.conv2d(
                        ...
                        normalizer_params={
                            'is_training': is_training},
                        scope='pyramid_fusion1')              #[1,360,1200,32]
